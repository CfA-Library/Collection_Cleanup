...
col_master = col_master[~col_master.COLLECTION.str.contains("CHTH")]
col_master = col_master[~col_master.COLLECTION.str.contains("CHTS")]
col_master = col_master[~col_master.COLLECTION.str.contains("DIGH")]
col_master = col_master[~col_master.COLLECTION.str.contains("DIGS")]
col_master = col_master[~col_master.COLLECTION.str.contains("DISSH")]
col_master = col_master[~col_master.COLLECTION.str.contains("DISSS")]
col_master = col_master[~col_master.COLLECTION.str.contains("EPHH")]
col_master = col_master[~col_master.COLLECTION.str.contains("EPHS")]
col_master = col_master[~col_master.COLLECTION.str.contains("FLWOS")]
col_master = col_master[~col_master.COLLECTION.str.contains("FOLCH")]
col_master = col_master[~col_master.COLLECTION.str.contains("FOLCS")]
col_master = col_master[~col_master.COLLECTION.str.contains("FOLH")]
col_master = col_master[~col_master.COLLECTION.str.contains("FOLS")]
